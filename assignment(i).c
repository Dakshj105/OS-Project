...
One student has pen, another has paper and another has question paper. the teacher places two things on a shared table 
...
the assignment and tells the teacher on completion. This cycle continues. Wap to synchronise the teacher and the students.*/
